...
namespace CousinPCMS.BLL
{
    public class CategoryService
    {
        ...
        public APIResult<string> AddCategory(AddCategoryModel objModel)
        {
            ...
            try
            {
                ...
                var response = ServiceClient.PerformAPICallWithToken(Method.Post, $"{HardcodedValues.PrefixBCODataV4Url}{HardcodedValues.TenantId}{HardcodedValues.SuffixBCODataV4Url}ProductCousinsProcess_InsertCategory?company={HardcodedValues.CompanyName}", ParameterType.RequestBody, Oauth.Token, postData.ToString());
        ...
        public APIResult<List<CategoryLinkedURlModel>> GetCategoryUrls(string categoryId)
        {
            ...
            try
            {
                ...
                var response = ServiceClient.PerformAPICallWithToken(Method.Get, $"{HardcodedValues.PrefixBCUrl}{HardcodedValues.TenantId}{HardcodedValues.SuffixBCUrl}categoryurls?company={HardcodedValues.CompanyName}", ParameterType.GetOrPost, Oauth.Token).Content;
        ...
        public APIResult<List<CategoryAdditionalImageModel>> GetCategoryAdditionalImages(string categoryId)
        {
            ...
            try
            {
                ...
                var response = ServiceClient.PerformAPICallWithToken(Method.Get, $"{HardcodedValues.PrefixBCUrl}{HardcodedValues.TenantId}{HardcodedValues.SuffixBCUrl}categoryadditionalimages?company={HardcodedValues.CompanyName}", ParameterType.GetOrPost, Oauth.Token).Content;
        ...
        public APIResult<string> UpdateCategoryAdditionalImage(UpdateCategoryAdditionalImageRequestModel objModel)
        {
            ...
            try
            {
                ...
                var response = ServiceClient.PerformAPICallWithToken(Method.Post, $"{HardcodedValues.PrefixBCODataV4Url}{HardcodedValues.TenantId}{HardcodedValues.SuffixBCODataV4Url}ProductCousinsProcess_UpdateCategoryAdditionalImages?company={HardcodedValues.CompanyName}", ParameterType.RequestBody, Oauth.Token, postData.ToString());
