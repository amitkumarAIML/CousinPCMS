    ...
    public class AccountService
    {
        ...
        public APIResult<LoginResponseModel> EmpLogin(EmpLoginRequestModel loginModel)
        {
            ...
            try
            {
                ...
                var response = ServiceClient.PerformAPICallWithToken(Method.Post, $"{HardcodedValues.PrefixBCODataV4Url}{HardcodedValues.TenantId}{HardcodedValues.SuffixBCODataV4Url}ProductCousinsProcess_validateToken?company={HardcodedValues.CompanyName}", ParameterType.RequestBody, Oauth.Token, postData.ToString());
