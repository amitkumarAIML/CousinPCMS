        ...
        <span className="flex gap-x-1">
          ...
          <a onClick={() => handleDeleteAttributeSet(record)}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9 15L15 9" stroke="#FF4E4E" strokeWidth="1.5" strokeLinecap="round" stroke-linejoin="round" />
              <path
              ...
              <path
                ...
                stroke-linejoin="round"
              />
              <path d="M4 4L20 20" stroke="#FF4E4E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </a>
        </span>
      ),
