export const theme = {
  token: {
    ...
    fontSizeLG: 13, // @progress-text-font-size (1.3em relative to 10px base)
  },
  components: {
    Form: {
      marginLG: 0, // @form-item-margin-bottom
      verticalLabelMargin: 8, // @form-vertical-label-margin
    ...
    Select: {
      ...
      fontSize: 12, // @select-dropdown-font-size
