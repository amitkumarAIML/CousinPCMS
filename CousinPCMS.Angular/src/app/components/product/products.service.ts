...
export class ProductsService {
  ...
  getAllProducts(pageIndex: number, pageSize: number,productName?: string): Observable<any> {
    return this.httpService.get<any>('Product/GetAllProducts', { pageSize: pageSize, pageNumber: pageIndex, productName: productName}).pipe(
